...
C {sky130_fd_pr/res_high_po.sym} -40 30 3 0 {name=R4
W=1
L=100
model=res_high_po
spiceprefix=X
mult=1}
C {sky130_fd_pr/cap_mim_m3_1.sym} -40 150 1 0 {name=C1 model=cap_mim_m3_1 W=1000 L=1000 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/nfet_01v8.sym} 120 250 0 1 {name=M3
L=0.5
W=50
nf=1 
mult=1
